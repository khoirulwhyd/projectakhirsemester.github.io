...
<div class="wrapper fadeInDown">
  <div id="formContent">
    <!-- Tabs Titles -->
    <h2 class="active">Selamat Datang Di Web Pemilihan Online<br>Pilihlah dengan hati nurani anda</h2>
    
<br>
<br>
    <!-- Icon -->
    <div class="fadeIn first">
      <img src="source/icon/user.png" id="icon" alt="User Icon" height="100px" />
    </div>
